...
?>
	...
	<footer id="colophon" class="site-footer">
		<div class="container footer-container">
			<div class="row">
				<div class="col-12 col-sm-6 col-lg-6 footer-links mb-container">
				...
				<div class="col-12 col-sm-6 col-lg-6 mb-container">
					<div class="soc-container">
						<a href="https://vk.com/excurs_orel" target="_blank">
							<svg class="svg-logo vk-logo" viewBox="0 0 112.196 112.196" alt="Логотип ВКонтакте">
						...
						<a href="https://www.facebook.com/groups/excursorel" target="_blank">
							<svg class="svg-logo fb-logo" viewBox="0 0 112.196 112.196" alt="Логотип фейсбука">
						...
						<a href="https://www.instagram.com/excurs_orel/" target="_blank">
							<svg class="svg-logo ig-logo" viewBox="0 0 89.758 89.758" alt="Логотип инстаграма">
			...
			<div class="copyr-container footer-links">© 2015-2019 <a href="<?php echo home_url(); ?>">«Экскурсии по Орлу»</a></div>
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
...
<?php wp_footer(); ?>
    ...
    <script type="text/javascript">
        VK.Widgets.Group("vk_groups", {mode: 3, width: "300", height: "400"}, 94410363);
    </script> -->
