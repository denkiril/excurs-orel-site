...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190305_ekskursiipoorlu_c92332d4654e7d293759_20190305232143_archive.zip';
	const ARCHIVE_SIZE		 = '429053722';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c92332d-05232143';
	const VERSION			 = '1.3.8';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.8==');
		self::log('----------------------------------------------------');
