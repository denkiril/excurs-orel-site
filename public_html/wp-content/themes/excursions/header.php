...
<head>
  ...
  <style>.svg-logo{width:50px;height:50px}.yt-logo-hovered{display:none}</style>
		...
		<div class="container">
			<div class="row">
				<div class="col header-container flex-container" itemscope itemtype="http://schema.org/Organization">
					...
					if ( $is_front_page ) {
						// 'мы не стоим на месте'. 'на удалёнке'. 'полезны для здоровья'.
						$header_subtitle = 'живём в учебнике истории';
					}
					?>
