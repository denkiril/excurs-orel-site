...
$links_array = array();
$consolelog  = '';
define( 'SCRIPTS_VER', '20220109' );
define( 'STYLES_VER', '20220323' );
	...
	register_post_type(
		...
		array(
			...
			'labels'              => array(
				...
				'all_items'          => 'Все события', // Все записи. По умолчанию равен menu_name.
	...
	register_post_type(
		...
		array(
			...
			'labels'              => array(
				...
				'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине.
				'parent_item_colon'  => '', // для родителей (у древовидных типов).
				'all_items'          => 'Все статьи', // Все записи. По умолчанию равен menu_name.
	...
	register_post_type(
		...
		array(
			...
			'labels'             => array(
				...
				'add_new_item'       => 'Добавление источника', // заголовка у вновь создаваемой записи в админ-панели.
				'edit_item'          => 'Редактировать источник', // для редактирования типа записи.
				'new_item'           => 'Новый источник', // текст новой записи.
				'view_item'          => 'Смотреть источник', // для просмотра записи этого типа.
				'search_items'       => 'Искать источники', // для поиска по этим типам записи.
				'not_found'          => 'Не найдено', // если в результате поиска ничего не было найдено.
				'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине.
				'parent_item_colon'  => '', // для родителей (у древовидных типов).
